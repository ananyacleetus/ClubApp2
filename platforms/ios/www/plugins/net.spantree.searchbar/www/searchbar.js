cordova.define("net.spantree.searchbar.searchbar", function(require, exports, module) { // Find the cordova reference used in the currently running app (differs based on version)
